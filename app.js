...
const PRODUCTS = [
...
},
  {
    ...
    colors: [
      ...
      { name: "Black", border: "black", images: ["bb1.jpeg", "bb2.jpeg", "bb3.jpeg"] },
    ],
  },
  {
    ...
    sizes: ["S", "M", "L", "XL"],
    gallery: ["streetsinheart1.jpeg", "streetsinheart2.jpeg"],
    colors: [
      { name: "Brown", border: "#76533B", images: ["brown1.jpeg", "brown2.jpeg"] },
      { name: "Brown2", border: "#76533B", images: ["bf1.jpeg", "bf2.jpeg"] },
      { name: "Black", border: "black",   images: ["streetsinheart1.jpeg", "streetsinheart2.jpeg"] },
      { name: "Black2", border: "black",   images: ["u1.jpeg", "u2.jpeg"] },
    ],
  },
  {
    name: 'Кофта "УЛИЦЫ В СЕРДЦАХ" 2',
    price: 3800,
    description: 'ДЕЛАЕМ ИСКЛЮЧИТЕЛЬНО ПО ПРЕДЗАКАЗУ! <br> Материал - хлопок 59% / эластан 41% <br> Плотность - 300 гр/м (без начеса) / оверсайз покрой <br> (Принт нанесен методом DTF печати) <br> Стирать при температуре 30 градусов, на изнанку / гладить на изнанку !',
    sizes: ["S", "M", "L", "XL"],
    gallery: ["sgold3.png"],
    colors: [
      { name: "Gold",  border: "gold", images: ["sgold3.png"] },
      { name: "Gold2",  border: "gold", images: ["gl11.jpeg"] },
      { name: "Pink",  border: "#D69E9D", images: ["streetspink3.jpeg"] },
      { name: "Pink2",  border: "#D69E9D", images: ["pn22.jpeg"] },
    ],
  },
  {
  ...
  {
    name: 'Футболка "КУЛЬТУРА МОЛОДЁЖИ" 2',
    price: 2200,
    description: 'ДЕЛАЕМ ИСКЛЮЧИТЕЛЬНО ПО ПРЕДЗАКАЗУ! <br> 1) цвет изделия - зависит от которого выбрали <br> 2) Состав изделия - оверсайз покрой (хлопок 100% / 250 гр/м) <br> Принт нанесен методом DTF печати <br> Стирать/гладить на изнанку ! <br> Стирать при 30 градусах',
    sizes: ["S", "M", "L", "XL"],
    gallery: ["bl11.jpeg"],
    colors: [
      { name: "Black",  border: "#020202", images: ["bl11.jpeg"] },
      { name: "White",  border: "white",   images: ["wh11.jpeg"] },
    ],
  },
  {
    ...
    description: 'ДЕЛАЕМ ИСКЛЮЧИТЕЛЬНО ПО ПРЕДЗАКАЗУ! <br> Материал - хлопок 59% / эластан 41% <br> Плотность - 300 гр/м (без начеса) / оверсайз покрой <br> (Принт нанесен методом DTF печати) <br> Стирать при температуре 30 градусов, на изнанку / гладить на изнанку !',
    sizes: ["S", "M", "L", "XL"],
    gallery: ["sweetred3.png"],
    colors: [
      { name: "Red",  border: "#BE3041", images: ["sweetred3.png"] },
      { name: "Blue", border: "#B7D3F0", images: ["sweetblue3.png"] },
      { name: "Beige", border: "#CDB5AB", images: ["beige.jpeg"] },
      { name: "Pink", border: "#D09DAC", images: ["pn.jpeg"] },
      { name: "Green", border: "#003F3B", images: ["gn.jpeg"] },
    ],
  },
  ...
  },
{
    ...
    colors: [
      ...
      { name: "White",  border: "white",  images: ["pr2.png"] },
    ],
  },
  {
...
{
    name: 'Футболка "Уличный спорт"',
    price: 2200,
    description: 'ДЕЛАЕМ ИСКЛЮЧИТЕЛЬНО ПО ПРЕДЗАКАЗУ! <br> 1) цвет изделия - зависит от которого выбрали <br> 2) Состав изделия - оверсайз покрой (хлопок 100% / 250 гр/м) <br> Принт нанесен способом DTF печати <br> Стирать без сушки. 30 град (Выворачиваем и стираем) ! И также гладим с наизнанки !',
    sizes: ["S", "M", "L", "XL"],
    gallery: ["lw1.png", "lw2.png"],
    colors: [
      { name: "White",   border: "white",   images: ["lw1.png", "lw2.png"] },
      { name: "Black",   border: "black",   images: ["lb1.png", "lb2.png"] },
    ],
  },
{
    name: 'Футболка "Уличный спорт" 2',
    price: 2200,
    description: 'ДЕЛАЕМ ИСКЛЮЧИТЕЛЬНО ПО ПРЕДЗАКАЗУ! <br> 1) цвет изделия - зависит от которого выбрали <br> 2) Состав изделия - оверсайз покрой (хлопок 100% / 250 гр/м) <br> Принт нанесен способом DTF печати <br> Стирать без сушки. 30 град (Выворачиваем и стираем) ! И также гладим с наизнанки !',
    sizes: ["S", "M", "L", "XL"],
    gallery: ["lw11.png", "lw22.png"],
    colors: [
      { name: "White",   border: "white",   images: ["lw11.png", "lw22.png"] },
      { name: "Black",   border: "black",   images: ["lb11.png", "lb22.png"] },
    ],
  },
{
    name: 'Футболка "База"',
  ...
  },
{
    name: 'Брелок "22TEAM"',
    price: 300,
    description: '  Выбранный размер и цвет не влияет на кол-во и качество наклеек! <br> Всё как на фото.',
    sizes: ["12", "12", "12", "12"],
    gallery: ["brelok.jpeg"],
    colors: [
      { name: "White", border: "white", images: ["stickerpack.png"] },
