...
const PRODUCTS = [
  ...
  },
  {
    ...
    price: 3650,
    description: 'ДЕЛАЕМ ИСКЛЮЧИТЕЛЬНО ПО ПРЕДЗАКАЗУ! <br> Материал - хлопок 59% / эластан 41% <br> Плотность - 300 гр/м (без начеса) / оверсайз покрой <br> (Принт нанесен методом DTF печати) <br> Стирать при температуре 30 градусов, на изнанку / <br> гладить на изнанку !',
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    price: 2000,
    description: 'ДЕЛАЕМ ИСКЛЮЧИТЕЛЬНО ПО ПРЕДЗАКАЗУ! <br> 1) цвет изделия - зависит от которого выбрали <br> 2) Состав изделия - оверсайз покрой (хлопок 100% / 250 гр/м) <br> Принт нанесен способом DTF печати <br> Стирать без сушки. 30 град (Выворачиваем и стираем) ! <br> И также гладим с наизнанки !',
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "Blue2",  border: "blue",   images: ["22blue2.png"] },
    ],
  },
{
    name: 'Футболка "База"',
